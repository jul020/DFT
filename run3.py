...
plt.title('Lattice vs. energy (k=12)')
...
for tx in range(485,516,1):
       ...
       jobname = "PTO_tx_%s_%s_%s" % (tx, alat, k)
...
for ty in range(485,516,1):
       ...
       # Let's define an easy jobname
       jobname = "PTO_ty_%s_%s_%s" % (ty, alat, k)
...
for tz in range(485,516,1):
       ...
       # Let's define an easy jobname
       jobname = "PTO_tz_%s_%s_%s" % (tz, alat, k)
